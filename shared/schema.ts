...
export const VETTED_CHARITIES = [
  ...
  // === ACE 2025 RECOMMENDED - INTERNATIONAL ANIMAL WELFARE ===
  {
    id: "aquatic-life-institute",
    name: "Aquatic Life Institute",
    wallet: null,
    twitterHandle: "ALI_Aquatic",
    payoutMethod: "twitter" as const,
    category: "animals",
    description: "Coalition-building and policy advocacy to improve welfare for farmed and wild aquatic animals",
  ...
  },
  {
    ...
    wallet: null,
    twitterHandle: "chkdtr",
    payoutMethod: "twitter" as const,
    category: "animals",
    description: "Turkish organization campaigning to end extreme confinement for farmed chickens and fish",
    website: "https://www.chkd.org.tr",
    countryCode: "TR",
    countryName: "Turkey",
  },
  {
    id: "dansk-vegetarisk-forening",
    name: "Dansk Vegetarisk Forening",
    wallet: null,
    twitterHandle: "vegetarforening",
    payoutMethod: "twitter" as const,
    category: "animals",
    description: "Danish Vegetarian Association promoting plant-based alternatives and institutional meat reduction",
    website: "https://vegetarisk.dk",
    countryCode: "DK",
    countryName: "Denmark",
  },
  {
    ...
    name: "Good Food Fund",
    wallet: null,
    twitterHandle: "GoodFoodFund",
    payoutMethod: "twitter" as const,
    category: "animals",
    description: "Supports plant-based food transitions and corporate campaigns in China to reduce meat consumption",
    website: "https://goodfoodfund.org",
    countryCode: "CN",
    countryName: "China",
  },
  {
    id: "sociedade-vegetariana-brasileira",
    name: "Sociedade Vegetariana Brasileira",
    wallet: null,
    twitterHandle: "SVBoficial",
    payoutMethod: "twitter" as const,
    category: "animals",
    description: "Brazilian advocacy for plant-based eating and institutional reforms to cut animal product use",
  ...
  },
  {
    ...
    wallet: null,
    twitterHandle: "AWO_Animal",
    payoutMethod: "twitter" as const,
    category: "animals",
    description: "Spain-based corporate and legislative campaigns to improve farmed chicken and fish welfare",
    website: "https://www.observatoriobienestaranimal.org",
    countryCode: "ES",
    countryName: "Spain",
  },
] as const;
